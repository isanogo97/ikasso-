    ...
    <div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="flex items-center gap-4 bg-white rounded-xl border border-gray-200 p-4">
          <div className="w-12 h-12 rounded-xl bg-orange-500 flex items-center justify-center text-white text-xs font-bold">
            OM
          </div>
          ...
          <span className="text-xs bg-green-100 text-green-700 px-2.5 py-1 rounded-full font-semibold">Actif</span>
        </div>

        {/* Carte bancaire via CinetPay */}
        <div className="flex items-center gap-4 bg-white rounded-xl border border-gray-200 p-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center text-white text-xs font-bold">
            CB
          </div>
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-900">Carte bancaire (Visa / Mastercard)</p>
            <p className="text-xs text-gray-500">Via CinetPay - paiement securise</p>
          </div>
          <span className="text-xs bg-amber-100 text-amber-700 px-2.5 py-1 rounded-full font-semibold">Bientot</span>
        </div>

        {/* Apple Pay */}
        <div className="flex items-center gap-4 bg-white rounded-xl border border-gray-200 p-4">
          <div className="w-12 h-12 rounded-xl bg-black flex items-center justify-center text-white text-sm font-bold">
            Pay
          </div>
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-900">Apple Pay</p>
            <p className="text-xs text-gray-500">Disponible sur Safari / iPhone</p>
          </div>
          <span className="text-xs bg-amber-100 text-amber-700 px-2.5 py-1 rounded-full font-semibold">Bientot</span>
        </div>
        ...
        {/* Google Pay */}
        <div className="flex items-center gap-4 bg-white rounded-xl border border-gray-200 p-4">
          <div className="w-12 h-12 rounded-xl bg-white border border-gray-300 flex items-center justify-center text-lg font-bold text-gray-700">
            G
          </div>
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-900">Google Pay</p>
            <p className="text-xs text-gray-500">Disponible sur Chrome / Android</p>
          </div>
          <span className="text-xs bg-amber-100 text-amber-700 px-2.5 py-1 rounded-full font-semibold">Bientot</span>
        </div>
        ...
        {/* Wave */}
        <div className="flex items-center gap-4 bg-white rounded-xl border border-gray-200 p-4">
          <div className="w-12 h-12 rounded-xl bg-blue-500 flex items-center justify-center text-white text-xs font-bold">
            W
          </div>
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-900">Wave</p>
            <p className="text-xs text-gray-500">Paiement mobile - populaire en Afrique de l'Ouest</p>
          </div>
          <span className="text-xs bg-amber-100 text-amber-700 px-2.5 py-1 rounded-full font-semibold">Bientot</span>
        </div>
      </div>
      ...
      <div className="bg-primary-50 border border-primary-100 rounded-xl p-4">
        <p className="text-sm font-semibold text-primary-900 mb-1">Paiement lors de la reservation</p>
        <p className="text-xs text-primary-700">
          Les moyens de paiement actifs seront proposes automatiquement lors du paiement d'une reservation.
          Les cartes bancaires, Apple Pay, Google Pay et Wave seront disponibles prochainement via CinetPay.
        </p>
      </div>
    </div>
  )
