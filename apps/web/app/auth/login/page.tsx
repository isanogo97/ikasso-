...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <span className="hidden sm:inline text-sm text-gray-600">Pas encore de compte ?</span>
      ...
      <div className="flex min-h-[calc(100vh-57px)] sm:min-h-[calc(100vh-65px)]">
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 text-base border-2 border-gray-200 rounded-xl focus:ring-0 focus:border-primary-500 transition-all"
                    value={email}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full pl-10 sm:pl-12 pr-12 py-3 sm:py-4 text-base border-2 border-gray-200 rounded-xl focus:ring-0 focus:border-primary-500 transition-all"
                    value={password}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-primary-500 hover:bg-primary-600 disabled:bg-gray-300 text-white py-3 sm:py-4 rounded-xl font-semibold transition-all text-base"
              >
                {isLoading ? (
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 py-3 sm:py-4 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-all"
              >
                ...
                <span className="font-medium text-gray-700 text-sm sm:text-base">Continuer avec Google</span>
              </button>
              ...
              >
                ...
                <span className="font-medium text-gray-700 text-sm sm:text-base">Continuer avec Apple</span>
              </button>
            </div>
        ...
        {/* Partie droite - Image/Illustration - Desktop only */}
